...
public class soignant extends RolesWithLimitedSelectionDuration implements AffectedPlayers
{
    private final List<UUID> affectedPlayer;
    
    public soignant(final GetWereWolfAPI main, final WereWolfAPI game, final UUID uuid) {
    ...
    public void onDay(final DayEvent event) {
        ...
        player.sendMessage(this.game.translate("werewolf.role.soignant.heal_message", new Object[0]));
    }
    
    public String getDescription() {
        return this.game.translate("werewolf.role.soignant.description", new Object[0]);
    }
    
    public String getDisplay() {
        return "werewolf.role.soignant.display";
    }
}
