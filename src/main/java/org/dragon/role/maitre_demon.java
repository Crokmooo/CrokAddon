...
public class maitre_demon extends RolesNeutral
{
    final Player player;
    
    public maitre_demon(final GetWereWolfAPI main, final WereWolfAPI game, final UUID uuid) {
    ...
    public String getDescription() {
        return this.game.translate("werewolf.role.maitre_demon.description", new Object[0]);
    }
    
    public String getDisplay() {
        return "werewolf.role.maitre_demon.display";
    }
