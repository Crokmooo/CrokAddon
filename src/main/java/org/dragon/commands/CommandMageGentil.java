...
public class CommandMageGentil implements Commands
{
    GetWereWolfAPI main;
    WereWolfAPI game;
    
    public CommandMageGentil(final GetWereWolfAPI main) {
        this.main = main;
    }
    ...
    public void execute(final CommandSender sender, final String[] args) {
        ...
        ((Mage)Mage).setChoice(org.dragon.role.Mage.MageForm.MAGE_Bienveillant);
        player.setMaxHealth(18.0);
        player.setHealth(18.0);
        ((Mage)Mage).setNeutre(false);
        sender.sendMessage(game.translate("werewolf.role.mage_gentil.description", new Object[0]));
